...
def run():
    print("Connecting to browser to upload images...")
    with sync_playwright() as p:
        try:
            ...
            for img in images:
                ...
                print(f"Uploading via WordPress REST API: {img['name']}...")
                ...
                async ([base64Data, filename, title]) => {
                    ...
                    // Optional: Update title of the uploaded image
                    try {
                        ...
                        console.error("Failed to update media title:", e);
                    }
                    
                    return {
                        id: mediaObj.id,
                        source_url: mediaObj.source_url,
                        width: mediaObj.media_details ? mediaObj.media_details.width : null,
                        height: mediaObj.media_details ? mediaObj.media_details.height : null
                    };
                }
                """
