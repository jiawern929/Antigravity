(function(){
  ...
  var injectIframe = function(){
    ...
    var src = 'https://keywordseverywhere.com/ke/3/' + page + '.php?apiKey=' + settings.apiKey + '&t=' + Date.now();
    if (DEV_MODE) {
